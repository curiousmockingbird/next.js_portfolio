    ...
    return (
        <>
            <SkeletonTheme baseColor="#202020" highlightColor="#444">
                <h1 className="text-center items-center justify-center p-10 mt-10 top-36 text-gray-500 text-3xl lg:text-4xl font-bold">Blog posts by Harold Mesa</h1>
                ...
                <section className="text-gray-300 body-font">
                    <div className="container mx-auto">
                        <div className="flex flex-wrap justify-center whitespace-break-spaces">
                            {post.map((c, index) => (
                                <div className="p-4 w-1/2 lg:w-1/3" key={index}>
