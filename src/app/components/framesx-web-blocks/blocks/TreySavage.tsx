...
export default function HarolDesigner() {
  return (
    ...
    >
      ...
      <BasicModal />
      <Button size='lg' component="a" href="https://treysavage.vercel.app/" target="_blank" startDecorator={<ArrowForward fontSize='large' />} onClick={() => logButtonClick("Deployment (GD Portfolio)")}>
        Deployment
      </Button>
      <Button size='lg' component="a" href="https://github.com/curiousmockingbird/treysavage.git" target="_blank" startDecorator={<GitHubIcon fontSize="large"/>} onClick={() => logButtonClick("Repo (GD Portfolio)")}>
        Github repo
      </Button>
    </TwoSidedLayout>
  );
