...
const RotatingImage: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-full relative">
      <Image
        className={`rounded-full ring-2 ring-neutral-200 dark:ring-neutral-700 shadow-sm transition-opacity duration-500 ${
...
const AboutText = () => (
  <>
    <p className="mb-4 leading-snug">
      I’m a bilingual full-stack developer and web manager transitioning into
      cybersecurity, with a focus on application security, network security, and
      secure web infrastructure. My background in building and maintaining
      websites, APIs, deployments, and digital systems gives me a practical
      understanding of how applications are built, how systems interact, and
      where vulnerabilities can emerge. 
    </p>
    <p className="mb-4 leading-snug">
      I’m currently expanding my foundation
      through ongoing cybersecurity training and certifications, developing
      broader, vendor-neutral knowledge across threat detection and mitigation,
      security architecture, identity and access management, incident response,
...
const ServicesSection = () => {
  const services = [
    ...
    {
      title: "TypeScript-first engineering",
      desc: "Type-safe APIs and components for maintainable codebases.",
    },
    {
    ...
    },
    {
      ...
      desc: "TanStack Query patterns, caching, optimistic updates.",
    },
    {
    ...
    {
      title: "Cloud hosting & CI/CD",
      desc: "Vercel deployments, previews, and performance monitoring.",
    },
    {
      title: "Email & notifications",
      desc: "SendGrid templates and transactional flows.",
    },
    {
      title: "Automation & internal tools",
      desc: "Google Apps Script for lightweight workflows and dashboards.",
    },
    {
      title: "Performance & accessibility audits",
      desc: "Core Web Vitals, semantics, keyboard/focus UX.",
    },
    {
      title: "SQL & data modeling",
      desc: "PostgreSQL/MySQL schema design, query optimization, indexes, migrations, and reporting.",
    },
  ];
  ...
  return (
    <section className="p-6 rounded-lg">
      ...
      <p className="mb-4 text-neutral-700 dark:text-neutral-300">
        I help teams ship reliable, accessible web products by combining strong
        UI design with solid engineering. Here’s how I can help:
      </p>
      <div
